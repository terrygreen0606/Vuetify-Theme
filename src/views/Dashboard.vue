    ...
    <div class="dashboard" v-if="isLogged">
        ...
        <v-container class="my-5">
                    ...
                    <v-tooltip top color="primary">
                        <template v-slot:activator="{ on }">
                            ...
                            >
                                ...
                                <span class="caption text-capitalize">By User</span>
                            </v-btn>
                        </template>
            ...
            <v-dialog v-model="deleteDialog" max-width="600px">
                <v-card>
                    <v-card-title class="headline">Are you sure to delete this project?</v-card-title>
                    <v-card-actions>
                        <v-spacer></v-spacer>
...
export default {
    ...
    created() {
        // Get the user status (logged in or out)
